...
describe('APP', function() {
  ...
  it('/get_tokenid_list', (done) => {
    chai.request(app).get('/get_tokenid_list').end((err, res) => {
      ...
      res.body.res[0].tokenID.should.equal(tokenID.toString('hex'))
      res.body.res[0].name.should.equal(tokenName.toString())
      res.body.res[0].symbol.should.equal(tokenSymbol.toString())
      done()
    })
  })
